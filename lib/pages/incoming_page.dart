                    ...
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) => ImageCheck(
                              text: 'Сохранить справку', chek: chek)),
                    );
                  },
                  child: Container(
                    decoration: BoxDecoration(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                              ...
                              children: [
                                Text(myCreditCard.provider,
                                    style: const TextStyle(
                                        ...
                                        fontWeight: FontWeight.w300)),
                                Text(
                                    '  ** ${myCreditCard.cardNumber.substring((myCreditCard.cardNumber.length) - 4)}',
                                    style: const TextStyle(
                        ...
                        SeparateIncomingDate(
                            textHight: 'Дата и время', textLow: "${chek.time}"),
                        const SizedBox(
                          height: 10,
                        ),
                        const SeparateIncomingDate(
                            textHight: 'Тип операции',
                            textLow: "Входящий перевод"),
                        const SizedBox(
                          height: 10,
                        ),
                        Row(
